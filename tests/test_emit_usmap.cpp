// Tests for the .usmap emitter. The assertions are about the bytes on disk, parsed back
// with a reader written here, not compared against a golden blob: a golden file
// tells you that output changed, this tells you which field is wrong.
